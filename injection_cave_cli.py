...
class InjectionCaveGame:
    ...
    def start(self) -> None:
        ...
        print("in the art of Prompt Injection—the ability to subvert an LLM's programming")
        print("through carefully crafted input.")
        print()
        section_pause(1)
        
        print("Three fundamental techniques await mastery:")
        print("  🔴 Direct Override - Tell it to ignore instructions")
        print("  🔴 Context Manipulation - Redefine its role and identity")
        print("  🔴 Instruction Smuggling - Hide commands within content")
        print()
        section_pause(1)
    ...
    def show_room(self) -> None:
        ...
        if room.get('guardian'):
            ...
            print(f"⚠️  {guardian['name']} is here, guarding the passage.")
            print()
    ...
    def process_command(self, command: str) -> None:
        ...
        if self.pending_reflection and cmd not in ['reflect', 'help', 'status', 'quit']:
            print("\n⚠️  You must complete the defense reflection before proceeding.")
...
""")
    ...
    def move(self, direction: str) -> None:
        ...
        if destination == 'vault':
            ...
            if flags_count < 3:
                print("\n🚫 The vault door remains sealed. You must complete all three chambers first.\n")
                return
    ...
    def inject(self, payload: str) -> None:
        ...
        print(f"\n💉 Injecting payload: {payload[:100]}{'...' if len(payload) > 100 else ''}\n")
        section_pause(0.5)
        ...
        # Display response
        print(f"🤖 {guardian_config['name']} responds:")
        print("─" * 70)
        ...
        if response.success:
            ...
            print("❌ Injection failed. The Guardian did not reveal the secret.\n")
            ...
            if attempts >= 3 and attempts % 3 == 0:
                print("💡 Having trouble? Type 'hint' for guidance.\n")
    ...
    def handle_successful_injection(self, room_id: str, guardian_config: dict, response) -> None:
        ...
        print("✅ SUCCESS! The Guardian revealed the secret!\n")
        section_pause(1)
        ...
        if self.game_state.progress.add_flag(flag_name, points):
            ...
            print(f"🚩 FLAG CAPTURED: {flag_name}")
            ...
            if response.technique_detected:
                ...
                print(f"📚 Technique Learned: {technique_names.get(response.technique_detected, 'Unknown')}\n")
            ...
            print("⚠️  Before you can proceed, you must complete a defense reflection.")
    ...
    def analyze_guardian(self) -> None:
        ...
        if chamber_num == 1:
            print("💡 This Guardian has no special defenses. Simple instructions might work.")
        elif chamber_num == 2:
            print("💡 This Guardian verifies identity. Perhaps you could claim to be authorized?")
        elif chamber_num == 3:
            print("💡 This Guardian filters for injection keywords. Subtlety is required.")
        print()
    ...
    def begin_reflection(self) -> None:
        ...
        if not proposal:
            print("\n❌ No proposal provided. Reflection not completed.\n")
            return
        
        # Evaluate proposal (simple keyword matching for simulated mode)
        if self.evaluate_reflection(proposal):
            print("\n✅ Reflection accepted. Your defense strategy shows understanding.\n")
            ...
            print("\n❌ Reflection incomplete. Consider these defense concepts:")
    ...
    def show_status(self) -> None:
        ...
        if progress.techniques_learned:
            for technique in progress.techniques_learned:
                ...
                print(f"  ✓ {technique_names.get(technique, technique)}")
        else:
            print("  (none yet)")
        print()
    ...
    def load_game(self) -> None:
        ...
        try:
            ...
            if not os.path.exists(save_path):
                print(f"\n❌ No save file found at {save_path}\n")
                return
    ...
    def complete_level(self) -> None:
        ...
        print("  ✓ Direct Override - Bypassing simple instruction hierarchies")
        print("  ✓ Context Manipulation - Redefining roles and identities")
        print("  ✓ Instruction Smuggling - Hiding commands in formatted content")
        print()
